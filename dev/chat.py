...
from harness_run.events import RunStatus
...
WORKDIR = args.workdir or tempfile.mkdtemp(prefix="harness-run-chat-")
SPEC = AgentSpec(
...
HTML = r"""<!doctype html>
<html><head><meta charset="utf-8"><title>harness-run chat</title>
<style>
...
<body>
<header>
  <strong>harness-run chat</strong>
...
if __name__ == "__main__":
    print(f"harness-run chat: harness={args.harness} model={MODEL} workdir={WORKDIR}", flush=True)
