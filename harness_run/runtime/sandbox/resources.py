...
#: Sampling cadence (seconds); ``HARNESS_RUN_RESOURCE_SAMPLE_S`` in the worker's env overrides, ``0`` disables.
DEFAULT_SAMPLE_S = 20.0
SAMPLE_S_ENV = "HARNESS_RUN_RESOURCE_SAMPLE_S"
...
class ResourceSampler:
    ...
    def __init__(
        ...
        self._thread = threading.Thread(
            target=self._run, name=f"harness-run-resources-{session_id[:8]}", daemon=True
        )
