...
from harness_run import AgentSpec, SkillSource, local
...
def test_run_forwards_the_chosen_workspace(tmp_path, monkeypatch):
    ...
    import harness_run.harness as harness_mod
...
def test_chosen_workspace_rejects_repos(tmp_path):
    ...
    from harness_run import RepoSource
    from harness_run.config import SessionConfig
